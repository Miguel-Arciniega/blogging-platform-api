...
/**
 * Represents the response details of a blog entry in the blogging platform.
 * This class is used as a data transfer object (DTO) for returning information
 * about a blog entry from the server to the client.
 * <p>
 ...
 * blogging platform API for presenting blog entry data to API consumers.
 */
@Data
@NoArgsConstructor
